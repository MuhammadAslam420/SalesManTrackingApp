                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th style="font-size:11px;font-weight:700;">Category</th>
                    ...
                    <tbody>
                        ...
                        @forelse ($subcategories as $category)
                            <tr>
                                ...
                                <td style="font-size:12px;font-weight:900;">{{$category->category->name}}</td>
                                ...
                                <td style="font-size:12px;font-weight:900;"> <a href="{{route('admin.edit_sub_category_form',['slug'=>$category->slug])}}" class="badge bg-primary"><i class="bi bi-pencil"></i></a></td>
