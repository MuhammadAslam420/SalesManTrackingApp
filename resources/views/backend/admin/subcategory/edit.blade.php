                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form method="post" action="{{ route('admin.update_sub_category',['slug'=>$subcategory->slug]) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="{{isset($subcategory) ? $subcategory->name : ''}}">
                                                @error('name')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <a href="{{ asset('assets/images/category') }}/{{ isset($subcategory) ? $subcategory->logo : '#' }}">
                                                    <img id="preview"
                                                        src="{{ asset('assets/images/category') }}/{{ isset($subcategory) ? $subcategory->logo : '#' }}"
