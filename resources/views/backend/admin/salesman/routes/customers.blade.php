    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-7 order-md-1 order-last">
                <h3>Add Customers To {{$route->name}} Route</h3>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{route('admin.store_customer_to_route',['routeId'=>$route->id])}}"
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="customer_Ids[]" id="customer_Ids" multiple="multiple" class="form-control">
                                                ...
                                                <option value="{{$customer->id}}">{{$customer->shopname}}</option>
                                                @endforeach
                                            </select>
                                            @error('customer_Ids')
